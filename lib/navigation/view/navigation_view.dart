...
class _NavigationViewState extends State<NavigationView> {
  ...
  // Giả sử hàm này kiểm tra xem user đã đăng nhập chưa
      ...
      tabBar: CupertinoTabBar(
        ...
        onTap: (index) {
          if (index == 3 && !isLoggedIn) {
            // Nếu chưa đăng nhập, đẩy trang Login lên stack (không có thanh điều hướng dưới)
            ...
            // Nếu đăng nhập hoặc không phải tab Profile, chuyển đổi tab bình thường
            setState(() {
